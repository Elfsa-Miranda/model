...
class DistillationLoss(nn.Module):
    ...
    def forward(self, student_features, teacher_features):
        ...
        Args:
            ...
            teacher_features: 老师模型特征列表 [layer_features, ...]
...
def test_distillation_loss():
    ...
    teacher_features = [
        torch.randn(batch_size, 18, 768),  # 老师模型层1（维度不同）
        torch.randn(batch_size, 18, 768),  # 老师模型层2
        torch.randn(batch_size, 18, 768),  # 老师模型层3
    ]
